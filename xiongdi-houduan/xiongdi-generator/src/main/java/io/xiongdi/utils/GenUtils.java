...
package io.xiongdi.utils;

import io.xiongdi.entity.ColumnEntity;
import io.xiongdi.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.xiongdi" : mainPath;
